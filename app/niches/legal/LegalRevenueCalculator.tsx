...
const LegalRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: "Initial Consultation", price: 300, cancellations: 8 },
    { name: "Contract Review", price: 450, cancellations: 5 },
  ]);

  const presetServices = [
    { name: "Initial Consultation", price: 300 },
    { name: "Contract Review", price: 450 },
    { name: "Legal Document Drafting", price: 600 },
    { name: "Court Representation", price: 850 },
    { name: "Business Formation", price: 750 },
    { name: "Real Estate Closing", price: 950 },
    { name: "Estate Planning", price: 650 },
    { name: "Divorce Consultation", price: 400 },
    { name: "Personal Injury Consultation", price: 350 },
    { name: "Immigration Services", price: 500 },
    { name: "Tax Legal Advice", price: 550 },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-inter">
              Calculate Your Legal Practice Revenue Recovery
            </h2>
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from cancelled legal
              consultations
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    ...
                    to customize it for your practice.
                  </p>
                </div>
              </div>
...
export default LegalRevenueCalculator;
