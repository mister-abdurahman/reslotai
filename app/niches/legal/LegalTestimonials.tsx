...
const LegalTestimonials = () => {
  const testimonials = [
    {
      rating: 5,
      text: "We recovered $8,200/month in just 4 weeks!",
      author: "James R.",
      title: "Managing Partner",
      business: "Wilson & Associates",
      image:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face",
    },
    {
      rating: 5,
      text: "ReslotAI reduced our no-show rate by 52% — clients appreciate the personal follow-up.",
      author: "Sarah M.",
      title: "Attorney",
      business: "Legal Partners LLC",
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b612b193?w=300&h=300&fit=crop&crop=face",
    },
    {
      rating: 5,
      text: "Setup was incredibly easy. It's rebooking consultations automatically.",
      author: "Michael K.",
      title: "Solo Practitioner",
      business: "Kramer Law Office",
      image:
    ...
    <section className="py-20 bg-gradient-to-br from-blue-900 to-purple-500">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-200">Trusted by 150+ law firms</p>
        </div>
