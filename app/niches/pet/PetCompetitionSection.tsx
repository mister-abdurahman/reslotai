...
const PetCompetitionSection = () => {
  const benefits = [
    {
      icon: <TrendingUp className="w-12 h-12 text-blue-600" />,
      title: "Maximize Appointment Slots",
      description: "More bookings through automation",
      detail: "Increase your clinic utilization by automatically filling cancelled slots with recovered appointments."
    },
    {
      icon: <Heart className="w-12 h-12 text-purple-600" />,
      title: "Pet Care Industry Expertise", 
      description: "Built for groomers and veterinarians",
      detail: "Custom-designed for pet grooming salons, veterinary clinics, and mobile pet services."
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-inter">
            How We Help Your Pet Care Business Outperform Competitors
          </h2>
...
export default PetCompetitionSection;
