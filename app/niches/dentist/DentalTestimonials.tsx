...
const DentalTestimonials = () => {
  const testimonials = [
    {
      rating: 5,
      text: "We recovered $8,400 in one month alone!",
    ...
    {
      rating: 5,
      text: "ReslotAI cut our no-show rate by 45% — patients love the smart reminders.",
      author: "Dr. Michael Chen",
      title: "Orthodontist",
      business: "Perfect Alignment Ortho",
      image:
        "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=300&h=300&fit=crop&crop=face",
    },
    {
      rating: 5,
      text: "Setup was incredibly easy. It's automatically rebooking cancelled cleanings.",
...
export default DentalTestimonials;
