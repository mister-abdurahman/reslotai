...
const DentalRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: "Cleaning", price: 120, cancellations: 15 },
    { name: "Crown", price: 1200, cancellations: 3 },
  ]);

  const presetServices = [
    { name: "Cleaning", price: 120 },
    { name: "Crown", price: 1200 },
    { name: "Filling", price: 250 },
    { name: "Root Canal", price: 800 },
    { name: "Extraction", price: 300 },
    { name: "Orthodontic Visit", price: 200 },
    { name: "Whitening", price: 400 },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from dental appointment
              cancellations
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    ...
                    common procedures and their typical cancellation rates.
                  </p>
                </div>
...
export default DentalRevenueCalculator;
