...
const TherapistPricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      monthlyPrice: 150,
      annualPrice: 1500,
      description: "Ideal for group practices and clinics",
      features: [
        "Up to 5 providers",
        "2,500 clients",
    ...
    },
    {
      ...
      monthlyPrice: 250,
      annualPrice: 2500,
      description: "For large therapy centers and practices",
      features: [
        "Unlimited providers",
        "Unlimited clients",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Often costs less than a single recovered therapy session
          </p>
