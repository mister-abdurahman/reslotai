      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join 300+ therapy practices already recovering thousands in lost
            revenue every month
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-blue-100">58% average recovery rate</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
...
export default TherapistFinalCTA;
