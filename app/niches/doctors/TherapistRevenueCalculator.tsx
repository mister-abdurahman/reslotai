...
const TherapistRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: "Individual Therapy", price: 150, cancellations: 8 },
    { name: "Couples Therapy", price: 200, cancellations: 5 },
  ]);

  const presetServices = [
    { name: "Individual Therapy", price: 150 },
    { name: "Couples Therapy", price: 200 },
    { name: "Family Therapy", price: 180 },
    { name: "Group Therapy", price: 80 },
    { name: "Psychological Assessment", price: 300 },
    { name: "EMDR Session", price: 175 },
    { name: "CBT Session", price: 160 },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-inter">
              Calculate Your Practice Revenue Recovery
            </h2>
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from therapy session
              cancellations
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    ...
                    common therapy sessions and their typical cancellation
                    rates.
                  </p>
                </div>
...
export default TherapistRevenueCalculator;
