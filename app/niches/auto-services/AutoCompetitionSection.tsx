...
const AutoCompetitionSection = () => {
  const benefits = [
    {
      icon: <TrendingUp className="w-12 h-12 text-blue-600" />,
      title: "Boost Appointment Volume",
      description: "More bookings through automation",
      detail: "Increase your service bay utilization by automatically filling cancelled slots with recovered appointments."
    },
    {
      icon: <Wrench className="w-12 h-12 text-purple-600" />,
      title: "Auto Industry Expertise", 
      description: "Built with your dealership workflow in mind",
      detail: "Custom-designed for automotive service departments, body shops, and quick-service locations."
    },
    {
...
export default AutoCompetitionSection;
