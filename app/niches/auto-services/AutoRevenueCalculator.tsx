...
const AutoRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: "Oil Change", price: 75, cancellations: 5 },
    { name: "Tire Rotation", price: 45, cancellations: 3 },
  ]);

  const presetServices = [
    { name: "Oil Change", price: 75 },
    { name: "Tire Rotation", price: 45 },
    { name: "Brake Service", price: 300 },
    { name: "Transmission Service", price: 250 },
    { name: "AC Service", price: 150 },
    { name: "Engine Diagnostic", price: 125 },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from automotive service
              cancellations
            </p>
          </div>
...
export default AutoRevenueCalculator;
