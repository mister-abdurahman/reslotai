        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl max-w-2xl mx-auto">
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl p-6 mb-6">
                <h4 className="text-xl font-semibold text-gray-800 mb-2">
                  `&quot;`How to Reduce Cancellations for Salons, Barbershops &
                  Beauty Studios`&quot;`
                </h4>
            ...
            <p className="text-sm text-gray-500 mt-4">
              No spam. Just proven tips trusted by 200+ beauty professionals.
            </p>
          </div>
        </div>
      </div>
...
export default BeautyPDFDownload;
