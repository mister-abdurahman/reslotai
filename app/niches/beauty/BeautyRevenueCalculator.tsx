...
const BeautyRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: "Haircut & Style", price: 65, cancellations: 12 },
    { name: "Hair Color", price: 120, cancellations: 8 },
  ]);

  const presetServices = [
    { name: "Haircut & Style", price: 65 },
    { name: "Hair Color", price: 120 },
    ...
    { name: "Wedding Package", price: 300 },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-inter">
              Calculate Your Salon Revenue Recovery
            </h2>
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from beauty appointment
              cancellations
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    ...
                    to customize it for your salon.
                  </p>
                </div>
              </div>
